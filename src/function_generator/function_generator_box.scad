...
if ($group == "demo" || $group == "top") {
  render_box_top($group == "demo" ? "demo" : "print", 21) {
    // Left knob.
    add_front_port_top([pcb_offset[0]+pcb_width-28.26,0,$thickness+pcb_bottom_clearance+$pcb_thickness+6.99], 7/2, 20) {
      // Right knob.
      add_front_port_top([pcb_offset[0]+pcb_width-15.04,0,$thickness+pcb_bottom_clearance+$pcb_thickness+6.99], 7/2, 19) {
        // Right BNC.
        add_front_port_top([pcb_offset[0]+16.09+16.71,0,$thickness+pcb_bottom_clearance+$pcb_thickness+12.25/2], 12.25/2, 18) {
          // Left BNC.
          add_front_port_top([pcb_offset[0]+16.09,0,$thickness+pcb_bottom_clearance+$pcb_thickness+12.25/2], 12.25/2, 17) {
...
if ($group == "demo" || $group == "bottom") {
  render_box_bottom($group == "demo" ? "demo" : "print", 13) {
    // Left knob.
    add_front_port_bottom([pcb_offset[0]+pcb_width-28.26,0,$thickness+pcb_bottom_clearance+$pcb_thickness+6.99], 7/2, 12) {
      // Right knob.
      add_front_port_bottom([pcb_offset[0]+pcb_width-15.04,0,$thickness+pcb_bottom_clearance+$pcb_thickness+6.99], 7/2, 11) {
        // Right BNC.
        add_front_port_bottom([pcb_offset[0]+16.09+16.71,0,$thickness+pcb_bottom_clearance+$pcb_thickness+12.25/2], 12.25/2, 10) {
          // Left BNC.
          add_front_port_bottom([pcb_offset[0]+16.09,0,$thickness+pcb_bottom_clearance+$pcb_thickness+12.25/2], 12.25/2, 9) {
